...
void i2cwritex(unsigned char i2c_device, unsigned char *i2c_data, unsigned int count, int sccb_flag)
{    
    int i;    
...
void i2cslowread(unsigned char i2c_device, unsigned char *i2c_data, unsigned int data_count, int sccb_flag)
{
    int i;    
